...
@endsection
@section('konten')
<a href="{{route('absen.create2')}}" class="btn btn-success btn-custom-width mb-2"><i class="fas fa-plus"></i> Absen Siswa</a>

<div class="card">
    <h5 class="card-header">Management Data Absen</h5>
    <div class="card-body">
        <form method="GET" action="{{ route('absen.index2') }}">
            <div class="row">
                <div class="col-md-4">
        ...
        <table id="dataTable" class="table">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    ...
                    <td>{{$da->guru->nama}}</td>
                    <td>
                        <a href="{{ route('absen.edit2', $da->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
