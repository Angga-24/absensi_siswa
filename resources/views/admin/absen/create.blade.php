...
@endsection
@section('konten')
<a href="{{route('absen.index2')}}" class="btn btn-success btn-custom-width mb-2"><i class="fas fa-arrow-left"></i> Kembali</a>

<div class="card">
    <h5 class="card-header">Absen Siswa</h5>
    <div class="card-body">
        <form method="GET" action="{{ route('absen.create2') }}">
            <div class="row">
                <div class="col-md-4">
    ...
    <div class="table-responsive text-nowrap">
        <form method="POST" action="{{ route('absen.updateStatus2') }}">
            @csrf
            <table class="table">
                <thead>
                    <tr>
